    ...
    return (
        ...
        viewport={{once: true, amount: 0.3}}>
            ...
            <motion.div className="mt-8 flex justify-center" variants={item}>
                <img src= "/imagens/sobre.jpeg" alt= "Foto do Sobre" className="bg-[#d3c912] w-80 h-92 rounded-xl flex items-center justify-center mb-8 border-4 border-white drop-shadow-[0_0_20px_#FFFF]" variants={item}/>
            </motion.div>
