...
const PortfolioCard = ({ title, image, index, onClick}) => {
    return (
        <motion.div 
        onClick={onClick}
        className={`cursor-pointer relative h-48 flex items-center justify-center gap-2 shadow-lg rounded-lg text-white font-semibold text-lg transition-transform duration-300 hover:scale-105 hover:brightness-110 ${image}`}
