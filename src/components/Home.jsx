    ...
    return (
        <section id="home" data-bg= "auto" className= {home}>
            ...
            animate = "visible">
                ...
                <motion.p className={homeP} variants={item}><motion.a href="https://www.instagram.com/bymaysalima/" target="_blank" rel="noopener noreferrer" className="ml-2 hover:shadow-lg hover:border-2 drop-shadow-[0_0_20px_#FFFF] rounded-lg p-1"><span className="text-white underline decoration-1 font-libreBaskerville">BYMAYSALIMA</span></motion.a></motion.p>
                <motion.h2 className={homeH2} variants={item}>Estudante de Publicidade e Propaganda <br /><span className="text-2xl">( StoryMaker e VideoMaker )</span></motion.h2>
