    ...
    return (
        <section id="home" className={home}>
            ...
            >
                ...
                >
                    <motion.div 
                        className="w-60 h-60 rounded-full flex items-center justify-center border-4 border-white mb-8 cursor-pointer shadow-lg overflow-hidden mt-4 drop-shadow-[0_0_20px_#FFFF]"
